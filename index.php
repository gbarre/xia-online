...
*/?>
			...
			<div class="login_form_links">
				...
				?>
						...
						<!-- Xia extend : add contact link and public page link -->
						<p><?php _e("If you need an account, please contact a server administrator.",'cftp_admin'); ?> <a href="mailto:guillaume-xia-online-request-account@jrmv.net?Subject=[Xia-Online] Demande de compte&amp;body=[Veuillez compléter cette demande en la motivant et en précisant votre nom et le login souhaités]">Contact</a></p>
						<p><a href="./public.php">Consulter les ressources publiques.</a></p>
				<?php
					}
				?>
			</div>
