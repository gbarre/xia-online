								...
								<div class="row edit_files">
									<div class="col-sm-12">
										<div class="row edit_files_blocks">
											...
											?>
													<!-- Xia Extend (change col-md-3 to col-md-4) -->
													<div class="col-sm-6 col-md-4 column_even column">
														<div class="file_data">
															<?php
																/**
											...
											?>
													...
													<div class="col-sm-6 col-md-4 assigns column">
														<!-- Xia extend (hide assigns & categories)-->
														<!--
														<div class="file_data">
															<?php
																/**
													...
													<div class="col-sm-6 col-md-3 categories column">
														...
														-->
														<?php include_once('./xe_edit-file.php'); ?>
														<!-- Close Xia extend -->
													</div>
											<?php
												} /** Close $current_level check */
